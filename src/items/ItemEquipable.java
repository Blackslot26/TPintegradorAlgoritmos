...
public enum ItemEquipable {
	...
	ESCUDODEHIELOPURO("Escudo de hielo puro", "Escudo forjado con hielo magico. Aumenta todas las estadisticas defensivas", 75000, 5, 30, 0.5, 0, true), //da un poco de todo
	GUANTELETESDELATLAS("Guanteletes del Atlas", "Guantes tecnologicos potenciados por magia runica. Aumentan todas las estadisticas.", 40000, 20, 20, 0.05, 0.1, false),
	ESPADAROTA("Espada Rota", "Una espada vieja y oxidada. Apenas mejor que nada.", 5000, 10, 0, 0, 0.1, false),
    ...
    COLGANTEDEFURIA("Colgante de Furia", "Un amuleto rojo que late con poder. Aumenta mucho el daño, pero te hace frágil.", 28000, 30, -10, -0.15, 0.0, true),
