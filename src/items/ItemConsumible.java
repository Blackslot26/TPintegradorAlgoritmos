...
public enum ItemConsumible {
	...
	PANACEA("La Panacea", "La cura a todos los males. Restaura completamente la vida del jugador.",10000, 100000, 0.5, 0.05, true),
	MANZANADORADA("Manzana Dorada", "AKA, Golden Apple. Cura vida y aumenta la suerte.", 15000, 50, 0.05, 0.1, true),
	...
	CARNEHUMANA("Carne Humana", "¿¿¿¿????", 1000, 10, -0.2, 0, false),
	...
	POCIONDEAVARICIA("Pocion de Avaricia", "Type of shit Isaac's father was pulling up home with. Aumenta las ganancias.", 50000, 0, 0, 1.2, true);
