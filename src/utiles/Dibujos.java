package utiles;
/**
 * Repositorio de arte ASCII utilizado para la ambientación visual del juego.
 * <p>
 * Contiene constantes estáticas con arrays de Strings que representan gráficos
 * (enemigos, escenarios, cartas) listos para ser impresos en consola.
 * </p>
 */
public class Dibujos {
	...
	public static final String[] DIBUJO_BLACKJACK = {
				    "   _____              /================================================\\   _____",
				    "  |A .  | _____      || ____  _            _       _            _    ||   |A _  | _____",
				    "  | /.\\ ||A ^  |     ||| __ )| | __ _  ___| | __  | | __ _  ___| | __||   | ( ) ||A_ _ |",
				    "  |(_._)|| / \\ |     |||  _ \\| |/ _` |/ __| |/ /  | |/ _` |/ __| |/ /||   |(_'_)||( v )|",
				    "  |  |  || \\ / |     ||| |_) | | (_| | (__|   < |_| | (_| | (__|   < ||   |  |  || \\ / |",
				    "  |____V||  .  |     |||____/|_|\\__,_|\\___|_|\\_\\___/ \\__,_|\\___|_|\\_\\||   |____V||  .  |",
				    "         |____V|      \\================================================/         |____V|"


	};
	
	public static final String[] DIBUJO_ALAS1 = {
			        "⠀⠀⠀⢀⡤⠒⡋⠑⢆⠀⠀⡰⠊⢉⠒⢦⡀⠀⠀⠀ ",
			        "⠀⠀⢠⠊⡠⠊⠀⢀⠎⠀⠀⠱⣄⠀⠑⢄⠙⣄⠀⠀ ",
			        "⠀⡰⠁⣠⣧⢂⠀⢧⠀⠀⠀⠀⡼⠀⡐⣼⣆⠈⢆⠀ ",
			        "⢀⠇⣰⠛⢿⡎⢄⠎⠀⠀⠀⠀⠱⡤⣱⡿⠛⣆⠸⡀",
	...
	public static final String[] DUBUJO_ALAS2 = {
			" ⡤⠒⢤⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡤⠒⢤",
			" ⢣⡀⠀⠉⠲⢤⣀⡀⠀⠀⠀⠀⠀⠀⢀⣀⡦⠖⠉⠀⢀⡜",
			" ⢸⡉⠒⠄⠀⠀⠀⢉⡙⢢⠀⠀⡔⢋⡉⠀⠀⠀⠠⠒⢉⡇",
			" ⠀⠉⢖⠒⠀⠀⠀⣇⠀⣸⠀⠀⣇⠀⣸⠀⣀⡀⠒⡲⠉⠀ ",
	...
	public static final String[] DIBUJO_ALAS3 = {
		    "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀",
		    "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣟⠈⠳⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣤⠞⠁⣻⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀",
		    "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⢦⡀⠀⠙⠲⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡤⠖⠉⠀⢀⡼⠃⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀",
		    "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢻⣍⠲⢄⡐⠤⣉⠓⠦⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣠⠴⠚⣁⠤⢂⡴⢫⡟⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀",
