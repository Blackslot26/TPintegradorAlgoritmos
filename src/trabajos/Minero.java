...
public class Minero extends Trabajar implements Accion {
	...
	public void realizar(Jugador jugador, Scanner sc) {
		...
		if (mineral < 40) { // encuentra carbon
			...
			jugador.modMonedas(ganancia); // gana un maximo de 2500 por minar
	...
	public String[] trabajarTextsBase(int ganancia) {
		...
		String[] hierro = { "¡Hierro! Una veta decente. El herrero te pagará " + ganancia + " monedas por esto.",
		...
		String[] redstone = { "¡Una piedra brillante! Los magos la aman. Ganas " + ganancia + " monedas.",
		...
		String[] diamante = { "¡Brilla! ¡Encontraste un diamante enorme! ¡Ganas " + ganancia + " monedas!",
		...
		String[] netherite = {
				...
				"¡Has encontrado el material de los dioses! ¡Te haces asquerosamente rico con " + ganancia
						+ " monedas!",
				"La veta sangra oscuridad... y te da " + ganancia + " monedas. ¡INCREÍBLE!" };

		if (mineral < 40)
			return carbon;
		if (mineral > 40 && mineral < 70)
			return hierro;
		if (mineral > 70 && mineral < 90)
			return redstone;
		if (mineral > 90 && mineral < 99)
			return diamante;
		if (mineral > 99)
			return netherite;
	...
	public String[] getDescriptionBase() {
		String[] a = { "Desciendes a las profundidades de la tierra, adentrandote en grutas desconocidas,",
